...
#define LEDS_OFF(x) omap_set_gpio(x, 0)
#define LEDS_ON(x) omap_set_gpio(x, 1)

///////////

#define CLEAR_GPIO(x) reg32w(0x49056090, 0, x)
#define SET_GPIO(x) reg32w(0x49056094, 0, x)

// turn leds on/off
#define LED0 0x00200000
#define LED1 0x00400000

#define LEDS_OFF_(x) CLEAR_GPIO(x)
#define LEDS_ON_(x) SET_GPIO(x)
